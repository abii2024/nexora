...
|---|---|---|---|
| Fatima El Amrani | `claudeabdi+tl@gmail.com` | teamleider (enige) | Rotterdam-Noord |
...
|---|---|---|---|
| 1 | Login als `claudeabdi+tl@gmail.com` | Op teamleider-dashboard | ✅ |
...
| 2 | Bewerk Jeroen, zet email op `claudeabdi+tl@gmail.com` (Fatima's email) | Form her-rendert met error "Er bestaat al een medewerker met dit e-mailadres." | ✅ |
