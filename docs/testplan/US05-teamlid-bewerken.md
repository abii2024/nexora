...
|---|---|---|---|
| Fatima El Amrani | `abdisamadvanabdulle@gmail.com` | teamleider (enige) | Rotterdam-Noord |
...
|---|---|---|---|
| 1 | Login als `abdisamadvanabdulle@gmail.com` | Op teamleider-dashboard | ✅ |
...
| 2 | Bewerk Jeroen, zet email op `abdisamadvanabdulle@gmail.com` (Fatima's email) | Form her-rendert met error "Er bestaat al een medewerker met dit e-mailadres." | ✅ |
