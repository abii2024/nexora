...
|---|---|---|---|---|---|
| Fatima El Amrani | `claudeabdi+tl@gmail.com` | `password` | teamleider | Rotterdam-Noord | ✓ |
...
| Stap | Actie | Verwacht resultaat | Werkelijk resultaat |
|---|---|---|---|
| 1 | Log in als `claudeabdi+tl@gmail.com` (Fatima, team Rotterdam) | Dashboard met sidebar | ✅ |
