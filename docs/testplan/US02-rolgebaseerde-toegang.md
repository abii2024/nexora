...
|---|---|---|---|---|---|
| Fatima El Amrani | `abdisamadvanabdulle@gmail.com` | `password` | teamleider | Rotterdam-Noord | ✓ |
...
| Stap | Actie | Verwacht resultaat | Werkelijk resultaat |
|---|---|---|---|
| 1 | Log in als `abdisamadvanabdulle@gmail.com` (Fatima, team Rotterdam) | Dashboard met sidebar | ✅ |
