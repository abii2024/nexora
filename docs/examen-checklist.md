...
| 14 | Screenshots van code van uitgewerkte functionaliteiten | [`docs/code-bewijslast/README.md`](code-bewijslast/README.md) — per US code-fragmenten met **GitHub-permalinks** naar specifieke regelnummers in de live repo. Optionele IDE-screenshots: zie §3 van [`screenshot-instructies.md`](screenshot-instructies.md). |
| 15 | Screenshots commit-geschiedenis en branches op GitHub | [`docs/github-bewijslast/README.md`](github-bewijslast/README.md) — alle 18 PRs, 4 sprint-tags, 18 feature-branches, commit-statistieken, ASCII git-graph. Live GitHub-views: [PRs](https://github.com/abii2024/nexora/pulls?q=is%3Apr+is%3Amerged) · [branches](https://github.com/abii2024/nexora/branches) · [tags](https://github.com/abii2024/nexora/tags) · [commits](https://github.com/abii2024/nexora/commits/main) · [network](https://github.com/abii2024/nexora/network). |
