...
- [ ] `02-pest-clientpolicy.png` — Pest-output van `./vendor/bin/pest tests/Feature/Policies` (alle 12 groen)
- [ ] `03-pest-clientscope.png` — Pest-output van `./vendor/bin/pest tests/Feature/Services` (alle 6 groen)
